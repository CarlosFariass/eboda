    ...
    <main className="min-h-screen bg-[#fafafa] dark:bg-[#060010] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <div className="relative mb-8">
          <h1 className="text-[150px] md:text-[200px] font-black leading-none text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-300 dark:from-purple-900/50 dark:to-pink-900/50 select-none">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-900 dark:from-purple-400 dark:to-pink-500 animate-pulse">
              404
            </span>
          </div>
        </div>
      ...
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-3">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-gray-700 to-gray-900 dark:from-purple-500 dark:to-pink-500 hover:from-gray-800 hover:to-black dark:hover:from-purple-600 dark:hover:to-pink-600 transition-all"
          >
